...
const RadialProgresBar = () => {
  ...
  const fullStrokeDashoffset =
    circumference + ((100 - progress) / 100) * circumference;

  return (
    <div
      x-data="scrollProgress"
      className="inline-flex items-center justify-center rounded-full bottom-5 left-5 w-full"
    >
      ...
      <span
        className="absolute text-5xl text-center text-white"
        x-text={progress}
      >
        {progress}%
      </span>
